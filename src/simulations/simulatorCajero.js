import { algoritmoLineal } from "../algorithms/algoritmoLineal.js";
...
export function simularCajero(replicas = 50, lambdaLlegadas = 10, lambdaServicio = 1 / 5) {
  
  let resultados = [];
  const maxUniformes = replicas * 200; 
  const uniformes = algoritmoLineal(17, 23, 10007, 12345, maxUniformes);
  let idxPoisson = 0;
...
console.log("=== Simulación Cajero de Supermercado ===");
simularCajero(50, 10, 1 / 5);
