    ...
    <div style={{ textAlign: "center", marginBottom: "16px" }}>
      ...
      <div className="result-cards-grid">
        ...
        <div className="result-card-v2" style={{ minWidth: "320px" }}>
          <span className="result-icon" role="img" aria-label="Conclusión">📝</span>
          <div className="result-title">Conclusión del análisis</div>
          <div className="result-value" style={{ fontSize: "1rem", color: "#f2f2f2", fontWeight: "normal", marginTop: "8px" }}>
            {interpretaciones[0].caso}
            <br />
            <span style={{ fontSize: "0.95rem", color: "#bdbdbd", textAlign: "justify", display: "block" }}>
